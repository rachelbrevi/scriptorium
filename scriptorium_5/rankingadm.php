...
// Busca ranking (top usuários por pontos)
...
<main>
    ...
    <div class="colunaesquerda">
        ...
        <div class="caixabotoes">
            ...
            <a href="rankingadm.php"><div class="botaoselect"><h3>Ranking</h3></div></a>
    ...
    <div class="colunadireita">
        ...
        <div class="telabusca">
            ...
            <!-- Top 3 -->
            <div class="top3 top3-container">
                <?php for($i = 0; $i < min(3, count($usuarios)); $i++): ?>
                    <div id="top3-card">
                        <h3>#<?php echo $i + 1; ?> - <?php echo htmlspecialchars($usuarios[$i]['nome_usuario']); ?></h3>
                        <p>- <?php echo number_format($usuarios[$i]['pontos_usuario'], 0);?> -</p>
                    </div>
                <?php endfor; ?>
            </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php for($i = 3; $i < count($usuarios); $i++): ?>
                                <tr>
                                    <td><?php echo $i + 1; ?></td>
                                    <td><?php echo htmlspecialchars($usuarios[$i]['nome_usuario']); ?></td>
                                    <td><?php echo number_format($usuarios[$i]['pontos_usuario'], 0); ?></td>
                                </tr>
                            <?php endfor; ?>
                        </tbody>
                    </table>
