...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO livros (titulo_livro, genero_livro, autor_livro, paginas_livro, idade_minima, capa_livro, isbn_livro, observacao, pontos_livro, dificuldade, formatacao) 
        VALUES ('$titulo', '$genero', '$autor', $paginas, $idade_min, '$capa', '$isbn', '$observacao', 0, '$dificuldade', '$formatacao')";
...
<head>
    ...
    <title>Scriptorium: Adicionar</title>
    <style>
    ...
    <div class="colunadireita">
        ...
        <div class="tela">
            <div class="telasuperior">
                <div><h2>Adicionar Livro</h2></div>
                <a href="paineladm.php"><h3 class="botaovoltar">Voltar</h3></a>
            </div>
                ...
                <form method="POST">
                    <div class="boxalinhamento">
                        <div class="box1">
                            ...
                            <input type="text" name="titulo" class="tituloinput" required>
                        </div>
                        <div class="box1">
                    ...
                    <div class="box1">
                        ...
                        <input type="text" name="autor" class="autorinput" required>
                    </div>
                    ...
                    <div class="boxalinhamento">
                        ...
                        <div class="box1">
                            ...
                            <input type="number" name="idade_min">
                        </div>
                        <div class="box1">
